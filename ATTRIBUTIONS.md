...
- **capture-lesson GP-NN format** — append-only numbered-lesson convention adapted from the raw-to-knowledge-playbook project's CONTRIBUTING.md.
...
- **book-to-skill** — the engine behind book distillation workflows; install from its public repo and run it on books you own. License: not verified — verify before relying.
